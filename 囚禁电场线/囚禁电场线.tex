...
\begin{align}
    ...
    &=\frac{1}{4\pi\epsilon_0}\sum_{l=0}^{\infty}\sum_{m=-l}^{l}\frac{4\pi}{2l+1}\left(\int\rho(\symbfit{r'})r'^lY_{lm}^*(\theta',\phi')\dd^3\symbfit{r'}\right)\frac{Y_{lm}(\theta,\phi)}{r^{l+1}}
    \label{eq:Multipole}
\end{align}
...
的线性组合，所以原问题相当于找一个电荷密度函数使得$\forall l\,\forall m\in\{-l,-l+1,\cdots,l\}\,\,p_{lm}=0$。考虑到球谐函数$Y_{lm}$的正交、完备、归一性，将
...
可以取：$R_{21}(r)=\dfrac{1}{r^4}\dfrac{\dd}{\dd r}r^6(R^6-r^6)=6R^6r-12r^{7}$，
