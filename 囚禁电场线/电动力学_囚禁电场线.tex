...
可以取：$R_{21}(r)=\frac{1}{r^4}\dfrac{\dd}{\dd r}r^6(R^6-r^6)=6R^6r^1-12r^{7}$，
此时有$\rho(\symbfit{r})=A(6R^6r^1-12r^{7})Y_{21}(\theta,\phi)$。
此电荷分布的任意阶极矩均为零。

\bigskip

以$\rho(\symbfit{r})=A(6R^6r^1-12r^{7})Y_{21}(\theta,\phi)$为例的一系列电荷构造
